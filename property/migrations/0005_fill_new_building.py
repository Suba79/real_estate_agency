# Generated by Django 5.2.14 on 2026-05-22 19:15
...
def rollback_new_building(apps, schema_editor):
    Flat = apps.get_model('property', 'Flat')
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(fill_new_building, rollback_new_building),
    ]
